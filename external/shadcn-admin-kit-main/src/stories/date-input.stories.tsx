...
export const Basic = ({ dateInputProps, simpleFormProps }: StoryProps) => (
...
export const CustomClassName = () => (
  <Wrapper>
    <DateInput source="publishedAt" inputClassName="max-w-xs" />
  </Wrapper>
);
...
export const NoLabel = () => (
  <Wrapper>
    <DateInput source="publishedAt" label={false} />
  </Wrapper>
);
