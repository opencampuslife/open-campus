# NPC Image Prompt — homeroom_teacher
...
```
[Subject] A female Chinese 班主任 character, 陈芷, front-facing portrait, modern pixel art style.
[Appearance] 低马尾辫. Wearing 浅绿色连衣裙.
...
```
[Subject] A female Chinese 班主任 character, 陈芷, three-quarter view portrait facing slightly left, modern pixel art style.
[Appearance] 低马尾辫. Wearing 浅绿色连衣裙.
...
```
[Subject] Full-body sprite of 陈芷 (homeroom_teacher), female Chinese 班主任, modern pixel art game sprite.
[Appearance] 低马尾辫. Wearing 浅绿色连衣裙. Skin tone #F4C7A1.
...
```
[Subject] 4-frame walk cycle sheet for 陈芷 (homeroom_teacher), female Chinese 班主任, modern pixel art.
[Appearance] 低马尾辫. Wearing 浅绿色连衣裙. Skin tone #F4C7A1.
