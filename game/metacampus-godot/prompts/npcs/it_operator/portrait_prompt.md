...
```
[Subject] A male Chinese IT运维 character, 许航, front-facing portrait, modern pixel art style.
[Appearance] 黑色短发. Wearing 灰色连帽衫，深色休闲裤. 黑框眼镜.
...
```
[Subject] A male Chinese IT运维 character, 许航, three-quarter view portrait facing slightly left, modern pixel art style.
[Appearance] 黑色短发. Wearing 灰色连帽衫，深色休闲裤. 黑框眼镜.
...
```
[Subject] Full-body sprite of 许航 (it_operator), male Chinese IT运维, modern pixel art game sprite.
[Appearance] 黑色短发. Wearing 灰色连帽衫，深色休闲裤. 黑框眼镜. Skin tone #F4C7A1.
...
```
[Subject] 4-frame walk cycle sheet for 许航 (it_operator), male Chinese IT运维, modern pixel art.
[Appearance] 黑色短发. Wearing 灰色连帽衫，深色休闲裤. 黑框眼镜. Skin tone #F4C7A1.
