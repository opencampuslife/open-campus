# NPC Image Prompt — logistics_manager
...
```
[Subject] A male Chinese 后勤主管 character, 赵启山, front-facing portrait, modern pixel art style.
[Appearance] 短发平头. Wearing 深灰工作服. 腰间对讲机.
...
```
[Subject] A male Chinese 后勤主管 character, 赵启山, three-quarter view portrait facing slightly left, modern pixel art style.
[Appearance] 短发平头. Wearing 深灰工作服. 腰间对讲机.
