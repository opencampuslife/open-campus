...
export function expandQuery(query: string, intent: string = "faq"): string {
...
export function expandWithTags(query: string, businessTags: string[]): string {
  if (typeof query !== "string") {
    throw new TypeError("sequence item 0: expected str instance, NoneType found");
  }
